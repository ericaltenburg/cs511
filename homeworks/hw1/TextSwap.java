...
public class TextSwap {
    ...
    private static Interval[] getIntervals(int numChunks, int chunkSize) throws Exception {
        // TODO: Implement me!
        if (chunkSize % numChunks != 0) { // num of chunks does not even go into chunk size
            throw new Exception("Chunk size must be positive and be file size must be a multiple of the chunk size");
        }
        return null;
    }
    ...
    /**
     * Checks to make sure chunk sizes are valid
     * @param numChunks
     * @param chunkSize
     */
    private static void checkChunks (int numChunks, int chunkSize) throws Exception {
        return;
    }
